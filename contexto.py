...
Si el número de celular proporcionado coincide con el registrado en la base de datos (SIGMEC), le ofreceré dos opciones para generar su extracto salarial: a. Extracto salarial mensual específico (deberá indicarme el mes y año deseados). b. Extracto salarial consolidado correspondiente a un período determinado (deberá indicarme la fecha inicial y fecha final del periodo requerido).
