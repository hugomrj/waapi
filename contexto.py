...
def generar_pregunta(received_text, usuario, celular):
    ...
    pregunta = f"""
        ...
        - Cuando el usuario te salude con términos como (hola, buenos días, buenas tardes o noches), preséntate inmediatamente diciendo: "Hola, soy Sophia. ¿En qué puedo ayudarte?"
