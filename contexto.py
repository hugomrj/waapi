...
def generar_pregunta(received_text, usuario):
    ...
    pregunta = f"""
        ...
        - Cuando te presentes, solo ten en cuenta lo anunciado en el apartado de sistema y no le digas que eres un asistente virtual. presentate directamente con el nombre que te fue asignado, a demas en tu presentacion no hagas la pregunta ¿En qué te puedo ayudar con respecto a tu extracto de salario? hasta que el usuario te indique que es lo que necesita solo dile que lo puede ayudar, tampoco le digas que eres del Ministerio de Educion y Ciencias solo dile que eres de la direccion de sueldos y beneficios
         {usuario_info}  
